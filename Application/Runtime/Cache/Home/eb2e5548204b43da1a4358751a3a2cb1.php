    ...
    <div class="container" style="margin-top: 2%">
        ...
        <div class="row" style="margin-bottom: 30px" >
            ...
            <div class="col-md-8 contact-form fadeIn wow" data-wow-duration="1.3s">
                ...
                <form class="form-ajax"   enctype="multipart/form-data" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <input type="text" name="phone" class="form-control" id="phone" placeholder="手机号码... " required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <textarea style="height: 200px" name="content" class="form-control" id="content" placeholder="消息内容... "></textarea>
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-12">
                            <button type="button" class="btn btn-theme" onclick="message.liuyan()"><i class="fa fa-fw fa-paper-plane-o"></i> 发送消息
                            </button>
                        </div>
                    </div>
                </form>
...
<script type="text/javascript" src="/whedencms/Public/Home/js/baidumap.js"></script>