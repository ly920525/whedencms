        ...
        <article class="container">
            ...
            <div class="col-xs-12 col-sm-7 col-md-8 col-lg-12 sf">
                    <ul>
                        ...
                        <li><a class="hover" href="<?php echo U('news/app');?>">APP开发</a></li>
                        <li><a class="hover" href="<?php echo U('news/weixin');?>">微信开发</a></li>
                        <li><a class="hover" href="<?php echo U('news/back');?>">后台搭建</a></li>
                    </ul>
            </div>
        <!-- 新闻列表页 start -->
