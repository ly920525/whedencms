  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" value="" name="simple" data-validate="required:请输入简介" />
          <div class="tips"></div>
        </div>
      </div>
      ...
      <div class="form-group">
        ...
        <div>
          <script id="editor" type="text/plain" style="width:1024px;height:500px;" name="text"></script>
        </div>
      </div>
...
<script type="text/javascript" charset="utf-8" src="/whedencms/Public/Admin/umeditor/ueditor.config.js"></script>
<script type="text/javascript" charset="utf-8" src="/whedencms/Public/Admin/umeditor/ueditor.all.min.js"> </script>
<script type="text/javascript" charset="utf-8" src="/whedencms/Public/Admin/umeditor/lang/zh-cn/zh-cn.js"></script>
