...
!function (a) {
    ...
    a.extend(a.fn, {
        ...
        messages: {
            ...
            rangelength: a.validator.format("请输入{ 0 }和{ } 1 }字符之间的值。"),
            range: a.validator.format("请输入{ 0 }和{ 1 }之间的值。"),
            max: a.validator.format("请输入小于或等于{ 0 }的值。"),
            min: a.validator.format("请输入大于或等于{ 0 }的值。")
        },
        autoCreateRanges: !1,
        prototype: {
            init: function () {
